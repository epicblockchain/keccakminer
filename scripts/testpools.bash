...
#
# Testscript to test keccakminer multiple pools/hosts/syntaxes
# Put this script in the bin directory of keccakminer and start running
#
...
# export some vars as "./keccakminer" could be still a wrapper script
...
for pool in $POOLS; do
    ...
    echo "./keccakminer -v 1 --exit --report-hashrate -P $pool $@"
    echo "./keccakminer -v 1 --exit --report-hashrate -P $pool $@" > log.txt
    ./keccakminer -v 1 --exit --report-hashrate -P $pool $@ >> log.txt 2>&1 &
    pid=$!
    #echo "PID=$pid"
