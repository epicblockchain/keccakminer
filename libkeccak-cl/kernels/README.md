# ethash-kernels
For whatever reason, Zawawawa released his Ethash kernels as open source code. This repo is a verbaitm copy of that code with a simplistic build environment and [Keccakminer](https://github.com/ethereum-mining/keccakminer) as a target. Although the code for Keccakminer has yet to be released.
